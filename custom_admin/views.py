...
def admin_settings(request):
    ...
    if request.method == 'POST':
        ...
        settings.geniuspay_api_key = request.POST.get('geniuspay_api_key', '').strip()
        settings.geniuspay_api_secret = request.POST.get('geniuspay_api_secret', '').strip()
        settings.geniuspay_webhook_secret = request.POST.get('geniuspay_webhook_secret', '').strip()
